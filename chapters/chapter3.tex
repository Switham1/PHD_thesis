...
\chapter{Architectural differences in \textit{cis}\hyp{}regulatory modules between constitutive, variable, non\hyp{}specific and tissue\hyp{}specific genes}\label{chapter3}
%read https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0212678 very relevant
%add points from this to intro: https://academic.oup.com/gbe/article/7/4/1002/531003
...
%expression level is highly influenced by no. of tissues a gene is expressed in (expression breadth) when expression data is pooled from EST libraries.
...
Multistimuli\hyp{}sensitive variably expressed genes were found to have significantly shorter 5$\prime$ UTR, gene length and cDNA lengths than constitutively expressed genes.
...
\subsection{Variably expressed and tissue-specific genes}\label{chapter3:introduction:variable-tissue-specific-genes}

Variably expressed genes include tissue-specific genes expressed in one or a few tissues, and responsive genes which are expressed in many tissues but are very variable in their expression.
These two categories are distinct from constitutive genes which are broadly and stably expressed across the majority of tissues and development stages.
It is important to note that the degrees of expression variability and tissue\hyp{}specificity are on a spectrum.

Network edges (TF\hyp{}target gene connections) have increased tissue\hyp{}specificity compared to network nodes (genes).
Additionally, regulating nodes (TFs) are less likely to be tissue\hyp{}specific than their target genes.
In humans nearly all TFs are associated with at least one tissue\hyp{}specific edge in all tissues, suggesting that even constitutively expressed TFs play a role in regulating tissue\hyp{}specific expression.
Network hub genes which interact with lots of other genes were more likely to be non\hyp{}tissue specific.
Tissue\hyp{}specific genes were less likely to be regulated by canonical TF\hyp{}DNA interactions in their promoter and were more likely to be regulated by non\hyp{}canonical means through TF complexes, alternative TFBSs or interactions outside of the promoter \autocite{sonawaneUnderstandingTissueSpecificGene2017}.

Four different gene categories plus a control category were selected to study promoter architecture.
These were constitutive, variable, non\hyp{}specific and tissue\hyp{}specific genes.

\textcite{czechowskiGenomeWideIdentificationTesting2005} ranked the stability of genes based on their coefficient of variation (CV).
Only genes present in \SI{80}{\percent} or more of developmental stages and tissues were included in the analysis.
This means that the variably expressed genes excluded tissue/condition\hyp{}specific genes and were classed based on how variable their expression was across the different tissues and developmental stages.
This was by design in the study to try to select stably expressed housekeeping genes for use as reference genes.

A constitutive gene set with low coefficient of variation was selected along with a variable gene set with high coefficient of variation.
Tissue/condition\hyp{}specific genes ranked using Tau tissue\hyp{}specificity were included as another gene set as their promoter architecture is expected to differ from constitutive and variably expressed non-tissue\hyp{}specific genes.
The genes with the lowest Tau ranking were categorised as non\hyp{}specific genes.

\subsection{GC content}\label{chapter3:introduction:gc-content}

Mammalian constitutive promoters have a higher GC content than tissue\hyp{}specific promoters \autocite{vinogradovDNAHelixImportance2017,weiCharacterizationGenePromoters2019}.
...
Additionally, GC-rich regions show an increased mutation rate compared to AT-rich regions \autocite{vinogradovDNAHelixImportance2017}.
...
In Arabidopsis, I hypothesise that constitutive promoters will have a higher GC content than variable promoters and I hypothesise that non\hyp{}specific promoters will have a higher GC content than tissue\hyp{}specific promoters.

\subsection{TFBS coverage}\label{chapter3:introduction:tfbs-coverage}
...
Constitutive promoters had more bps covered by TFBSs than tissue-specific promoters \autocite{mattioliHighthroughputFunctionalAnalysis2019}, suggesting that the promoters of constitutive genes are more complex. In Arabidopsis, highly variable genes were targeted by more TFs, tended to be shorter and contained fewer introns than constitutive genes \autocite{cortijoWidespreadInterindividualGene2019}.
...
There was no significant correlation between motif density and breadth of response for down\hyp{}regulation events~\autocite{waltherRegulatoryCodeTranscriptional2007}.
The first 500 bp upstream of the TSS were found to contain a stronger correlation between breadth of stimuli response and motif density than 500\textendash{}1000 bp upstream and 1000\textendash{}3000 bp upstream of the TSS~\autocite{waltherRegulatoryCodeTranscriptional2007}.
In Arabidopsis I hypothesise that TFBS percentage coverage of promoters will be higher in variable genes than in constitutive genes, and higher in tissue-specific genes than non\hyp{}specific genes..

\subsection{TF diversity}\label{chapter3:introduction:tf-diversity}
...
In Arabidopsis I hypothesise that variable genes responding to many stimuli will contain a higher diversity of TFBSs than constitutive genes that respond to a narrow range of stimuli, and tissue\hyp{}specific genes will contain a higher diversity of TFBSs than non\hyp{}specific genes.
...
In humans, GA\hyp{}repeat regions were associated with divergent promoters.
Additionally, the introduction of a GA\hyp{}binding protein binding site into unidirectional promoters turned \SI{67}{\percent} of them into bidirectional promoters~\autocite{collinsEtsRelatedTranscriptionFactor2007}.
...
In plants, TATA boxes are enriched in genes responding to more stimuli (i.e., variably expressed genes) over genes responding to a narrow breadth of stimuli (i.e., constitutive genes, tissue\hyp{}specific genes).
These variably expressed genes containing TATA boxes tend to have shorter 5$\prime$ UTRs \autocite{waltherRegulatoryCodeTranscriptional2007,molinaGenomeWideAnalysis2005,lichtenbergWordLandscapeNoncoding2009}
...
Genes responding to a narrow breadth of stimuli tend to be constitutive or tissue\hyp{}specific.
Motifs associated with constitutive genes (TELO-box motif \autocite{tremousayguePlantInterstitialTelomere1999}; hexamer motif \autocite{chaubetIdentificationCiselementsRegulating1996}) and also those conferring tissue\hyp{}specific expression (e.g. LEAFYATAG \autocite{kamiyaIsolationCharacterizationRice2003}) were associated with narrow\hyp{}breadth response genes \autocite{waltherRegulatoryCodeTranscriptional2007}.
Therefore, it would be useful to split variably expressed genes into narrow\hyp{}breadth response and multistimuli response categories when making comparisons with constitutive genes.
In Arabidopsis I hypothesise that TATA boxes will be enriched in variable genes compared to constitutive genes, and will be enriched in tissue\hyp{}specific genes over non\hyp{}specific genes.
...
Genes coding for master\hyp{}regulator TFs are classed as multi\hyp{}interface (MI) hub genes, while those coding for lesser connected TFs are classed as single interface (SI) hub genes.
Within MI genes, constitutive and tissue\hyp{}specific CDSs showed similar evolutionary rates, while within SI genes constitutive gene CDSs evolve more slowly than tissue-specific gene CDSs~\autocite{podderMultifunctionalityDominantlyDetermines2009}.
MI tissue\hyp{}specific genes evolved more slowly than SI tissue\hyp{}specific genes, while both MI and SI constitutively expressed genes evolved at similar rates~\autocite{biswasEvolutionaryRateHeterogeneity2018}.
This was explained by the fact that tissue\hyp{}specific MI genes are bound by more miRNAs than tissue\hyp{}specific SI genes~\autocite{biswasEvolutionaryRateHeterogeneity2018}, and genes with more miRNA targets evolve more slowly~\autocite{chengRelationshipEvolutionMicroRNA2009}.
...
\section{Aims}\label{chapter3:aims}
The first aim is to elucidate promoter architectural differences between different gene expression categories in Arabidopsis.
Specifically, whether promoter features such as TATA boxes, TFBS density, GC content, TFBS diversity and  chromatin percentage coverage of \textit{cis}\hyp{}regulatory modules differ between constitutive, variable, non\hyp{}specific and tissue\hyp{}specific genes.
The second aim is to learn design features needed to construct synthetic minimal N\hyp{}responsive promoters.
\section{Results}\label{chapter3:results}
...
After the filtering process, the methodology described by \textcite{czechowskiGenomeWideIdentificationTesting2005} was used to select the top 100 constitutive and variable genes.
Tau tissue\hyp{}specificity ranking was used to select the top 100 non\hyp{}specific and tissue\hyp{}specific genes.
The mean $log_{2}$ expression of the genes in each category are shown in \autoref{fig:gene-group-expression}.
...
\begin{figure}[hbt!]
	\begin{center}
		\capstart
		\includegraphics[width=0.60\columnwidth]{genes/labelled_distribution_cv_distribution}
		\caption{
...
The Tau tissue\hyp{}specificity distribution of the top 100 tissue\hyp{}specific genes was narrower than the top 100 non\hyp{}specific genes (\autoref{fig:tau-distribution}).


\begin{figure}[hbt!]
	\begin{center}
		\capstart
		\includegraphics[width=0.60\columnwidth]{genes/labelled_distribution_tau_distribution}
		\caption{
...
%			The top 300 non\hyp{}specific were chosen based on tau tissue\hyp{}specificity values after filtering overlapping genes and genes with no TFBSs in their promoters.
%			Boxes coloured as followed: light red, \textit{p} \textless{} 0.005; grey, \textit{p} \textgreater{} 0.05 (non-significant study terms).
%			p < 0.01, light orange
%			The gene ontology enrichment analysis was calculated using Fisher's exact test \autocite{fisherInterpretationContingencyTables1922} and Benjamini/Hochberg FDR correction \autocite{benjaminiControllingFalseDiscovery1995}.
%			\label{fig:go-variable}
...
CRMs from the four gene sets were overlapped with ATAC-seq data (control treated plants \autocite{potterCytokininModulatesContextdependent2018}).
This allowed the chromatin accessibility to be described.
Constitutive, variable and control CRMs had a significantly different percentage of nucleotides covered by open chromatin (Kruskal\hyp{}Wallis~\textit{H} = 37.5,~\textit{P} \textless{} 0.0001).
Dunn's post hocs with Bonferroni correction showed that variable CRMs had a significantly lower percentage of nucleotides covered by open chromatin (\SI{35.0}{\percent} ± 35.1) than constitutive (\SI{54.1}{\percent} ± 33.3;~\textit{P} \textless{} 0.001) or control (\SI{65.3}{\percent} ± 30.4;~\textit{P} \textless{} 0.0001) CRMs (\autoref{fig:chromatin-coverage}A).
...
\begin{figure}[hbt!]
	\begin{center}
		...
		\caption{
			...
			5$\prime$ UTRs were extended downstream of the TSS to the closest coding region.
			...
			\textit{N}=100.
			Significance was calculated using Kruskal\hyp{}Wallis and Dunn's post hocs with Bonferroni correction.
...
From \textasciitilde{}250 bp to \textasciitilde{}450 bp upstream of the start codon the median open chromatin in non\hyp{}specific CRMs decreased to zero while tissue\hyp{}specific CRMs had a median percentage open chromatin of 0 (\autoref{fig:openchrom-sliding-window}B).
...
\begin{figure}[!hbt]
	\begin{center}
		...
		\caption{
			...
			Shading represents \SI{95}{\percent} confidence intervals estimated using 10000 bootstraps.
...
To confirm whether this was a true difference or due to different 5$\prime$ UTR lengths between constitutive and variable genes, the percentage of root\hyp{}shoot intersect open chromatin of windows was plotted centred around the Araport11 TSS.
This separated windows located in promoter regions from those in 5$\prime$ UTRs regions.
...
When analyses were repeated with the top 300 CRMs in each category the results supported the findings of the top 100 CRMs.
...
Dunn's post hocs with Bonferroni correction revealed that mean percentage GC content was significantly higher in constitutive CRMs (\SI{32.8}{\percent} ± 4.3) than variable CRMs  (\SI{31.7}{\percent} ± 3.6;~\textit{P} \textless{} 0.05) (\autoref{fig:gc-content-wholeprom}A).
...
\begin{figure}[hbt!]
	\begin{center}
		...
		\caption{
			...
			Promoters were extracted 1000 bp upstream of the annotated Araport 11 \autocite{chengAraport11CompleteReannotation2017} TSS or until the nearest gene.
			5$\prime$ UTRs were extended downstream of the TSS to the closest coding region.  Box plots have box boundaries that represent 25th, 50th (median) and 75th percentiles; whiskers are drawn up to the largest or smallest observed point that falls within 1.5 times the interquartile range.
...
\begin{figure}[hbt!]
	\begin{center}
		...
		\caption{
			...
			Control genes are identical in plots A and B.
			Significance was calculated using Kruskal\hyp{}Wallis followed by Dunn's post hocs with Bonferroni correction.
...
When analyses were repeated using the top 300 CRMs in each category, all GC content findings supported those found when using the top 100 CRMs.
...
The hypothesis that tissue\hyp{}specific genes have a higher TFBS coverage than non\hyp{}specific genes was also  tested.
TFBS coverage did not differ significantly between non\hyp{}specific, tissue\hyp{}specific or control CRM types at the whole promoter level (Kruskal\hyp{}Wallis~\textit{H} = 5.6,~\textit{P} \textgreater{} 0.05; \autoref{fig:tfbs-coverage-wholeprom}B).
...
Dunn's post hocs with Bonferroni correction revealed that TFBS coverage in open chromatin of variable CRMs (\SI{7.3}{\percent} ± 8.8) was significantly lower than constitutive CRMs (\SI{11.3}{\percent} ± 8.5;~\textit{P} \textless{} 0.001) and control CRMs (\SI{12.9}{\percent} ± 9.1;~\textit{P} \textless{} 0.0001).
...
Dunn's post hocs with Bonferroni correction revealed that TFBS coverage in open chromatin of tissue\hyp{}specific CRMs (\SI{3.5}{\percent} ± 6.0) was significantly lower than non\hyp{}specific CRMs (\SI{10.0}{\percent} ± 10.1;~\textit{P} \textless{} 0.0001) and control CRMs (\SI{12.9}{\percent} ± 9.1;~\textit{P} \textless{} 0.0001).
...
Dunn's post hocs with Bonferroni correction showed that variable promoters had a significantly higher percentage bp covered (\SI{26.1}{\percent} ± 14.6) than constitutive CRMs (\SI{20.0}{\percent} ± 13.7; \textit{P} \textless 0.01) and control CRMs (\SI{21.1}{\percent} ± 13.8; \textit{P} \textless 0.05).
...
Dunn's post hocs showed that tissue\hyp{}specific CRMs had significantly higher TFBS percentage coverage (\SI{25.1}{\percent} ± 14.6) than non\hyp{}specific CRMs (\SI{19.4}{\percent} ± 13.3; \textit{P} \textless 0.05).
...
Dunn's post hocs with Bonferroni correction showed that variable CRMs had a significantly lower TFBS coverage (\SI{10.5}{\percent} ± 14.2) in open chromatin than constitutive (\SI{15.2}{\percent} ± 13.4; \textit{P} \textless{} 0.05) and control CRMs (\SI{16.1}{\percent} ± 14.0; \textit{P} \textless{} 0.01).

Within the same 400 bp region non\hyp{}specific, tissue\hyp{}specific and control CRMs also had significantly different TFBS coverage in open chromatin (Kruskal\hyp{}Wallis~\textit{H} = 74.7,~\textit{P} \textless{} 0.0001; \autoref{fig:tfbs-coverage-400bpprom-openchrom}B).
Dunn's post hocs with Bonferroni correction revealed that tissue\hyp{}specific CRMs had significantly lower TFBS coverage (\SI{2.5}{\percent} ± 7.0) in open chromatin than non\hyp{}specific (\SI{13.4}{\percent} ± 14.0; \textit{P} \textless{} 0.0001) and control CRMs (\SI{16.1}{\percent} ± 14.0; \textit{P} \textless{} 0.0001).

\begin{figure}[hbt!]
	\begin{center}
		\capstart
		\includegraphics[width=1\columnwidth]{TFBS_coverage/400bpprom_openchrom/TFBS_coverage_violin}
		\caption{
			\textbf{Mean percentage coverage of TFBS falling within open chromatin in different Arabidopsis \textit{cis}\hyp{}regulatory module (CRM) expression categories in a 400 bp region upstream of the ATG start codon.}
			A: Mean percentage coverage of TFBS falling within open chromatin in 400 bp constitutive, variable and control CRMs. \textit{N}=100.
			B: Mean percentage coverage of TFBS falling within open chromatin in 400 bp non\hyp{}specific, tissue\hyp{}specific and control CRMs. \textit{N}=100.
			Significance was calculated using Kruskal\hyp{}Wallis and Dunn's post hocs with Bonferroni correction.
			**, \textit{P} \textless{} 0.01. *, \textit{P} \textless{} 0.05. ns, not significant.
...
When analyses were repeated using the top 300 CRMs in each category, most findings supported those found with the top 100 CRMs.
However, at the whole CRM level, there was a significant difference in TFBS coverage between non\hyp{}specific, tissue\hyp{}specific and control CRMs (\textit{N} = 300; Kruskal\hyp{}Wallis~\textit{H} = 7.7;~\textit{P} \textless{} 0.05).
Dunn's post hocs with Bonferroni correction revealed that tissue\hyp{}specific CRMs had a significantly higher TFBS coverage (\SI{19.0}{\percent} ± 8.8) than non\hyp{}specific CRMs (\SI{17.6}{\percent} ± 9.5; \textit{P} \textless{} 0.05).

\subsection{TF diversity}
The hypothesis that variable genes have a higher diversity of TFs binding them than constitutive genes was tested.
There was no significant difference in TF (Kruskal\hyp{}Wallis~\textit{H} = 0.9,~\textit{P} \textgreater{} 0.05) or TF family Shannon diversity (Kruskal\hyp{}Wallis~\textit{H} = 0.5,~\textit{P} \textgreater{} 0.05) between constitutive, variable or control types (\autoref{fig:tf-diversity-wholeprom}A).

There was also no significant difference in TF (Kruskal\hyp{}Wallis~\textit{H} = 2.3,~\textit{P} \textgreater{} 0.05) or TF family diversity (Kruskal\hyp{}Wallis~\textit{H} =2.3,~\textit{P} \textgreater{} 0.05) between non\hyp{}specific, tissue\hyp{}specific or control CRMs (\autoref{fig:tf-diversity-wholeprom}B).
...
A sliding window analysis revealed that in the constitutive open chromatin region 50-150 bp upstream of the ATG start codon variable promoters looked to have slightly higher Shannon diversity than constitutive promoters (\autoref{fig:tf-diversity-sliding-window}A) and tissue\hyp{}specific promoters looked to have a higher Shannon diversity than non\hyp{}specific promoters (\autoref{fig:tf-diversity-sliding-window}B).
Median TF family Shannon diversity did not differ from 0 at any point along the CRM for any gene category.

In a 400 bp region upstream of the TSS the same TF Shannon diversity analyses were run.
Again no significant difference in TF or TF family diversity was found between any CRM types whether using all TFBSs or only including those falling within open chromatin (All Kruskal-Wallis tests,~\textit{P} \textgreater{} 0.05).
...
\begin{figure}[hbt!]
	\begin{center}
		...
		\caption{
			...
			Windows are offset by 50 bp.
			Shading represents 95 confidence intervals estimated using 10000 bootstraps.
			A: Median Shannon diversity of individual TFs sliding windows in constitutive and variable CRMs. \textit{N}=100.
			B: Median Shannon diversity of individual TFs sliding windows in non\hyp{}specific and tissue\hyp{}specific CRMs. \textit{N}=100.
			\label{fig:tf-diversity-sliding-window}
		}
	\end{center}
\end{figure}

A principal component analysis was run using the Shannon diversity of TF families binding promoters in each category to elucidate whether some TF families were more important for defining a promoter category.
To test the hypothesis that constitutive genes are bound by a different set of TF families than variable genes, Kmeans clustering was conducted.
Kmeans clustering of the diversity of TF families binding to 400 bp CRMs did not correspond to gene type (\autoref{fig:pca-cv}).

\begin{figure}[hbt!]
	\begin{center}
		\capstart
		\includegraphics[width=1\columnwidth]{TF_diversity/400bpprom/PCA_Kmeans_TF_family_counts_cv}
		\caption{
			\textbf{Two PCA components accounting for the highest percent of variation for Shannon diversity of TF families binding promoters of constitutive and variable genes.}
			A principal component analysis was run where \SI{95}{\percent} of the variation was maintained with 22 components.
			Hierarchical clustering was used to estimate the number of clusters, K, using the silhouette method \autocite{rousseeuwSilhouettesGraphicalAid1987} which was then used in as K in Kmeans clustering.
			A, points coloured with two Kmeans clusters.
			B, points coloured by gene type. Constitutive genes, blue. Variable genes, orange. Control genes, green.
			\label{fig:pca-cv}
		}
	\end{center}
\end{figure}

To test the hypothesis that non\hyp{}specific genes are bound by a different set of TF families than tissue\hyp{}specific genes, Kmeans clustering was conducted.
Kmeans clustering of the diversity of TF families binding 400 bp CRMs did not correspond to gene type (\autoref{fig:pca-tau}).
\begin{figure}[hbt!]
	\begin{center}
		\capstart
		\includegraphics[width=1\columnwidth]{TF_diversity/400bpprom/PCA_Kmeans_TF_family_counts_tau}
		\caption{
			\textbf{Two PCA components accounting for the highest percent of variation for Shannon diversity of TF families binding promoters of non\hyp{}specific and tissue\hyp{}specific genes.}
			A principal component analysis was run where \SI{95}{\percent} of the variation was maintained with 22 components.
			Hierarchical clustering was used to estimate the number of clusters, K, using the silhouette method \autocite{rousseeuwSilhouettesGraphicalAid1987} which was then used in as K in Kmeans clustering.
			A, points coloured with two Kmeans clusters.
			B, points coloured by gene type. Non\hyp{specific} genes, green. Tissue\hyp{}specific genes, grey. Control genes, brown.
			\label{fig:pca-tau}
		}
	\end{center}
\end{figure}
The number of genes included in the analyses of TF and TF family diversity using only TFBSs falling within open chromatin was low (ranging from \textit{N} = 20 to \textit{N} = 54) because genes with no TFBSs in open chromatin were filtered out.

To increase sample size, all analyses were repeated using the top 300 CRMs in each category.
The findings mainly supported the results found with the top 100 CRMs in each category except for the following.

%At the whole CRM level there was no significant difference in TF (\textit{N} = 300; Kruskal\hyp{}Wallis~\textit{H} = 0.8, ~\textit{P} \textgreater{} 0.05) or TF family diversity (\textit{N} = 300; Kruskal\hyp{}Wallis~\textit{H} = 0.6, ~\textit{P} \textgreater{} 0.05) between constitutive, variable and control CRMs.
%There was also no significant difference in TF (\textit{N} = 208; Kruskal\hyp{}Wallis~\textit{H} = 0.8;~\textit{P} \textgreater{} 0.05) or TF family diversity (\textit{N} = 208; Kruskal\hyp{}Wallis~\textit{H} = 1.0; ~\textit{P} \textgreater{} 0.05) when only using TFBSs falling within open chromatin.
%There was a significant difference in TF Shannon diversity between non\hyp{}specific, tissue\hyp{}specific or control CRMs (\textit{N} = 300, Kruskal\hyp{}Wallis~\textit{H} = 13.2, ~\textit{P} \textless{} 0.01).
%Dunn's post hocs with Bonferroni correction revealed that control genes had a significantly higher Shannon diversity (2.8 ± 0.8) than non\hyp{}specific (2.6 ± 1.0; ~\textit{P} \textless{} 0.05) and tissue\hyp{}specific genes (2.6 ± 0.9; ~\textit{P} \textless{} 0.01).
%There was a significant difference TF family diversity non\hyp{}specific, tissue\hyp{}specific and control CRMs (\textit{N} = 300, Kruskal\hyp{}Wallis~\textit{H} = 8.0;~\textit{P} \textless{} 0.05).
%Dunn's post hocs with Bonferroni correction revealed that control CRMs had a significantly higher TF family diversity (1.9 ± 0.5) than tissue\hyp{}specific CRMs (1.8 ± 0.6;~\textit{P} \textless{} 0.05).
Using only TFBSs falling within open chromatin in the whole CRM there was a significant difference in TF diversity between non\hyp{}specific, tissue\hyp{}specific and control CRMs (\textit{N} = 112, Kruskal\hyp{}Wallis~\textit{H} = 10.2;~\textit{P} \textless{} 0.01).
Dunn's post hocs with Bonferroni correction revealed that tissue\hyp{}specific CRMs (2.1 ± 1.2) had a significantly lower TF diversity than non\hyp{}specific (2.5 ± 1.0;~\textit{P} \textless{} 0.05) and control CRMs (2.6 ± 0.9;~\textit{P} \textless{} 0.01).
%Using only TFBSs falling within open chromatin there was also a significant difference in TF family diversity between non\hyp{}specific, tissue\hyp{}specific and control CRMs (\textit{N} = 112, Kruskal\hyp{}Wallis~\textit{H} = 11.5;~\textit{P} \textless{} 0.01).
%Dunn's post hocs with Bonferroni correction revealed that tissue\hyp{}specific CRMs (1.4 ± 0.8) had a significantly lower TF family diversity than control CRMs (1.8 ± 0.6;~\textit{P} \textless{} 0.01).

%At the 400 bp promoter level there was a significant difference in TF diversity between constitutive, variable and control CRMs (\textit{N} = 300; Kruskal\hyp{}Wallis~\textit{H} = 6.0, ~\textit{P} \textless{} 0.05).
%However, Dunn's post hocs with Bonferroni correction revealed no significant difference between groups (\textit{P} \textgreater{} 0.05).

%In the same 400 bp CRM there was no significant difference in TF family diversity between constitutive, variable and control CRMs (\textit{N} = 300; Kruskal\hyp{}Wallis~\textit{H} = 5.0, ~\textit{P} \textgreater{} 0.05).

%At the 400 bp promoter level there was a significant difference in TF diversity between non\hyp{}specific, tissue\hyp{}specific and control CRMs (\textit{N} = 300; Kruskal\hyp{}Wallis~\textit{H} = 7.7, ~\textit{P} \textless{} 0.05).
%Dunn's post hocs with Bonferroni correction revealed that non\hyp{}specific CRMs (2.1 ± 1.2) had a significantly lower TF diversity than control CRMs (2.3 ± 1.0;~\textit{P} \textless{} 0.05).
There was also a significant difference in TF family diversity in the 400 bp CRM between non\hyp{}specific, tissue\hyp{}specific and control CRMs (\textit{N} = 300; Kruskal\hyp{}Wallis~\textit{H} = 8.1,~\textit{P} \textless{} 0.05).
Dunn's post hocs with Bonferroni correction revealed that non\hyp{}specific CRMs (1.3 ± 0.8) had a significantly lower TF diversity than control CRMs (1.5 ± 0.7;~\textit{P} \textless{} 0.05) and tissue\hyp{}specific CRMs (1.5 ± 0.7;~\textit{P} \textless{} 0.05).

%There was no significant difference in TF or TF family diversity in the 400 bp promoter within open chromatin between constitutive, variable and control CRMs or between non\hyp{}specific, tissue\hyp{}specific and control CRMs (All Kruskal-Wallis tests; \textit{P} \textgreater{} 0.05).
...
%ADD KMEANS CLUSTERING PLOT TOO
...
% The Tau tissue\hyp{}specificity of TFs predicted to bind CRMs did not differ significantly between tissue\hyp{}specific, non\hyp{}specific and control CRMs (\textit{N} = 100; Kruskal\hyp{}Wallis~\textit{H} = 3.8;~\textit{P} \textgreater{} 0.05).
...
% However, Dunn's post hocs with Bonferroni correction did not reveal an significant difference between any two categories (~\textit{P} \textgreater{} 0.05).
...
% Dunn's post hocs with Bonferroni correction revealed no significant difference between any two categories (\textit{P} \textgreater{} 0.05).
...
% Dunn's post hocs with Bonferroni correction revealed that the mean Tau tissue\hyp{}specificity was significantly higher for TFs binding non\hyp{}specific CRMs (0.70 ± 0.16) than TFs binding tissue\hyp{}specific CRMs (0.66 ± 0.16;~\textit{P} \textless{} 0.01; \autoref{fig:TFBS-TF-class-400bpprom-openchrom}).
% %add figure%
% \begin{figure}[hbt!]
% 	\begin{center}
% 		\capstart
% 		\includegraphics[width=1\columnwidth]{TFBS_TF_class/400bpprom_openchrom/TF_expression_categories_box}
% 		\caption{
...
% 			\label{fig:TFBS-TF-class-400bpprom-openchrom}
% 		}
% 	\end{center}
% \end{figure}
...
% Dunn's post hocs with Bonferroni correction revealed that TFs binding non\hyp{}specific CRMs had a significantly higher Tau tissue\hyp{}specificity (0.68 ± 0.16) than tissue\hyp{}specific CRMs (0.67 ± 0.16;~\textit{P} \textless{} 0.01).
...
% Dunn's post hocs with Bonferroni correction revealed that TFs binding non\hyp{}specific CRMs in open chromatin had a significantly higher Tau tissue\hyp{}specificity (0.68 ± 0.16) than control CRMs (0.66 ± 0.16;~\textit{P} \textless{} 0.05).
...
% Dunn's post hocs with Bonferroni correction revealed that TFs binding CRMs of non\hyp{}specific genes had a significantly higher Tau tissue\hyp{}specificity (0.67 ± 0.16) than TFs binding CRMs of tissue\hyp{}specific genes (0.66 ± 0.15;~\textit{P} \textless{} 0.05).
...
% Dunn's post hocs with Bonferroni correction revealed that TFs binding non\hyp{}specific CRMs in open chromatin had significantly higher Tau tissue\hyp{}specificity (0.69 ± 0.16) than TFs binding tissue\hyp{}specific (0.65 ± 0.15;~\textit{P} \textless{} 0.0001) or control CRMs (0.66 ± 0.15;~\textit{P} \textless{} 0.01).

%\subsection{Transcription factor target}
%170 TFs in each category chosen - as only 571 TFs present in all genes set and needs to be divisible by 10 for the control set. Not many of the TFs predicted to bind promoters in the whole gene set (18 cv, 23 tau with top 150 TFs in each category). Control set still need standardising between the two sets. Leave this analysis out of chapter as samples sizes too small!

%Mention top 300 in each category - non-specific significantly lower TF family diversity than tissue_specific p<0.05

%TALK ABOUT 5$\prime$ UTR lengths - test if constitutive have longer 5$\prime$ UTR lengths (check for expected  hypothesis first and see if useful comparison or not)
%\begin{figure}[!h]
%	\begin{center}
%		\capstart
