...
\hyp{}sensitive variably expressed genes were found to have significantly shorter 5$\prime$ UTR, gene length and cDNA lengths than constitutively expressed genes.
...
For non\hyp{}parametric analyses the Kruskal\hyp{}Wallis \textit{H} test \autocite{kruskalUseRanksOneCriterion1952} was used to test for differences between constitutive, variable and control promoters using the scikit-posthocs package (v0.6.4)\autocite{terpilowskiScikitposthocsPairwiseMultiple2019}.
...
The hypothesis that there is no significant difference in CV or Tau of TFs binding CRMs in constitutive/variable or non\hyp{}specific/tissue\hyp{}specific categories was tested (\href{https://github.com/Switham1/PromoterArchitecture/blob/master/src/plotting/map_TF2CV_TF2Tau_combined.py}{map_TF2CV_TF2Tau_combined.py}).
