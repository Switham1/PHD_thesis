...
\begin{figure}[hbt!]
	...
	\end{center}
\end{figure}
The same analysis was run again using only TFBSs that fall within open chromatin. TFBS coverage differed significantly between constitutive, variable and control categories (Kruskal\hyp{}Wallis~\textit{H} = 27.1,~\textit{P} \textless{} 0.0001;\autoref{fig:tfbs-coverage-wholeprom-openchrom}A). Dunn's posthocs with Bonferroni correction revealed that TFBS coverage in open chromatin of constitutive CRMs (\SI{11.3}{\percent} ± 8.5) was significantly higher than variable CRMs (\SI{7.3}{\percent} ± 8.8; ~\textit{P} \textless{} 0.001) and significantly lower than control CRMs (\SI{12.9}{\percent} ± 9.1; ~\textit{P} \textless{} 0.0001).
