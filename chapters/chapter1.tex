...
A sliding window analysis of GC content revealed that the biggest differences in GC content with small confidence intervals between constitutive and variable promoters was $\tilde{}$400 bp upstream of the ATG start codon (\autoref{fig:gc-content-sliding-window}).
