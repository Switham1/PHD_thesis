...
\begin{figure}[hbt!]
	\begin{center}
		...
		\caption{
			\textbf{Percentage open chromatin coverage in different Arabidopsis \textit{cis}\hyp{}regulatory module (CRM) expression categories.}		
...
\begin{figure}[hbt!]
	\begin{center}
		...
		\caption{
			\textbf{Percentage GC content in different Arabidopsis \textit{cis}\hyp{}regulatory module (CRM) expression categories.}
			Promoters were extracted 1000 bp upstream of the annotated Araport 11 \autocite{chengAraport11CompleteReannotation2017} TSS or until the nearest gene.
...
\begin{figure}[hbt!]
	\begin{center}
		...
		\caption{
			\textbf{Percentage GC content of different Arabidopsis \textit{cis}\hyp{}regulatory module (CRM) expression categories in a 400 bp region upstream of the ATG start codon.}
