...
GC content was significantly different between gene types (Kruskal\hyp{}Wallis~\textit{H} = 14.8,~\textit{P} \textgreater{} 0.001; \autoref{fig:gc-content-wholeprom}) Dunn's posthocs revealed that GC content was significantly higher in constitutive CRMs than variable CRMs.
