...
In mammals CDSs evolve more slowly in constitutive genes than variable genes \autocite{zhangMammalianHousekeepingGenes2004}.
In plants constitutive genes are also more conserved than variable genes \autocite{armisenUniqueGenesPlants2008,wrightEffectsGeneExpression2004}.
...
%is this between species conservation or within species???
%if between species you woulndt expect promoter sequence conservation, only expression conservation (see armisenUniqueGenesPlants2008)
...
The genes responding to many stimuli, i.e. variably expressed genes, are also flanked by larger intergenic regions so are less likely to be overlapping other genes or to have bidirectional promoters. 
The longer intergenic regions possibly allow for increased regulation complexity. These variably expressed genes were found to have significantly shorter 5'UTR, gene length and cDNA length than constitutively expressed genes.
Variably expressed genes also had fewer introns and were more likely to have paralogues in the Arabidopsis genome than than constitutively expressed genes.

Constitutive genes tended to respond to fewer stimuli.
...
In Arabidopsis 500 bp promoters no significant GO term enrichment or gene family associations were found in constitutive or variable genes categories \autocite{waltherRegulatoryCodeTranscriptional2007}.
...
In plants, TATA boxes are enriched in genes responding to more stimuli (i.e. variable genes) over genes responding to a narrow breadth of stimuli (i.e. constitutive genes). These variably expressed genes containing TATA boxes tend to have shorter 5'UTRs \autocite{waltherRegulatoryCodeTranscriptional2007,molinaGenomeWideAnalysis2005,lichtenbergWordLandscapeNoncoding2009}.
Hypothesis: In Arabidopsis, TATA boxes will be enriched in variable genes compared to constitutive genes.

In Arabidopsis \autocite{waltherRegulatoryCodeTranscriptional2007}% what organism? \autocite{waltherRegulatoryCodeTranscriptional2007} found that to be true in arabidopsis
...
\begin{figure}[hbt!]
	\begin{center}
		...
		\caption{
			Distribution of coefficient of expression variation (CV) values for all \textit{Arabidopsis thaliana} genes after filtering overlapping genes and genes with no TFBSs in their promoters.
...
\begin{figure}[!h]
	\begin{center}
		...
		\caption{
			Log2\hyp{}fold enrichment of 15 bp TATA boxes in 100 variable (blue) and 100 constitutive (orange) Arabidopsis \textit{cis}\hyp{}regulatory modules (CRMs) compared to a background of constitutive and variable promoters combined.
			Promoters were extracted 1000 bp upstream of the annotated Araport 11 \autocite{chengAraport11CompleteReannotation2017} TSS or until the nearest gene.
			5UTRs were extended downstream of the TSS to the closest coding region.
