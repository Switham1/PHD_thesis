...
\begin{figure}[hbt!]
	...
	\end{center}
\end{figure}
The same analysis was run again using only TFBSs that fall within open chromatin. TFBS coverage differed significantly between constitutive, variable and control categories (Kruskal\hyp{}Wallis~\textit{H} = 2.4,~\textit{P} \textless{} 0.05;\autoref{fig:tfbs-coverage-wholeprom-openchrom}A)
