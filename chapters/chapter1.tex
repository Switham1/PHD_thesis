...
A sliding window analysis of GC content revealed the biggest differences in GC content between constitutive and variable promoters was within 400 bp upstream of the ATG start codon (\autoref{fig:gc-content-sliding-window}).

\begin{figure}[!h]
	\begin{center}
		\capstart
		\includegraphics[width=0.50\columnwidth]{GC_content/wholeprom/Czechowski_genetypenocontrol_percentage_GC_content_sliding_window}
		\caption{
			...
			A: Median percentage of open chromatin found in 100 bp windows.
