...
To confirm whether this was a genuine difference or due to different 5'UTR lengths between constutitive and variable genes, the percentage of root\hyp{}shoot intersect open chromatin of windows was plotted from the Araport11 TSS (\autoref{fig:gc-content-sliding-window-araporttss}).
The median percentage open chromatin decreased upstream of the TSS for both constitutive and variable genes, and constutive genes ahd a higher percentage open chromatin -100 to + 500 bp around the TSS (ADD STATS).
...
\begin{figure}[!h]
	\begin{center}
		\capstart
		\includegraphics[width=1\columnwidth]{GC_content/wholeprom/Czechowski_genetypenocontrol_percentage_GC_content_sliding_window}
		\caption{
...
\begin{figure}[!h]
	\begin{center}
		\capstart
		\includegraphics[width=1\columnwidth]{GC_content/wholeprom/Araport11_Czechowski_genetypenocontrol_openchromatin_sliding_window}
		\caption{
			Sliding window analysis of 100 constitutive (blue) and 100 variable (orange) Arabidopsis \textit{cis}\hyp{}regulatory modules (CRMs). Promoters were extracted 1000 bp upstream of the annotated Araport 11 \autocite{chengAraport11CompleteReannotation2017} TSS or until the nearest gene.
			5UTRs were extended downstream of the TSS to the closest coding region.
			Data points are positioned in the centre of each 100 bp window.
			...
			\label{fig:gc-content-sliding-window-araporttss}
		}
	\end{center}
\end{figure}
