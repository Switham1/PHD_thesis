...
%	\begin{center}
%		\capstart
%		\includegraphics[width=0.40\columnwidth]{genes/labelled_distribution_cv_distribution}
%		\caption{
...
%\end{figure}
%
%The Tau tissue\hyp{}specificity distribution of the top 100 tissue\hyp{}specific genes was narrower than the top 100 non\hyp{}specific genes (\autoref{fig:tau-distibution).
%
%
%\begin{figure}[hbt!]
%	\begin{center}
%		\capstart
%		\includegraphics[width=0.40\columnwidth]{genes/labelled_distribution_tau_distribution}
%		\caption{
...
Dunn's posthocs with Bonferroni correction revealed that tissue\hyp{}specific CRMs had significantly lower TFBS coverage (\SI{2.5}{\percent} ± 7.0) in open chromatin than non\hyp{}specific (\SI{13.4}{\percent} ± 14.0; \textit{P} \textless 0.0001) and control CRMs (\SI{16.1}{\percent} ± 14.0; \textit{P} \textless 0.0001).
...
Dunn's posthocs with Bonferroni correction revealed that tissue\hyp{}specific CRMs had a significantly higher TFBS coverage (\SI{19.0}{\percent} ± 8.8) than non\hyp{}specific CRMs (\SI{17.6}{\percent} ± 9.5; \textit{P} \textless 0.05).
...
%Dunn's posthocs with Bonferroni correction revealed that control genes had a significantly higher Shannon diversity (2.8 ± 0.8) than non\hyp{}specific (2.6 ± 1.0; ~\textit{P} \textless{} 0.05) and tissue\hyp{}specific genes (2.6 ± 0.9; ~\textit{P} \textless{} 0.01).
...
%Dunn's posthocs with Bonferroni correction revealed that control CRMs had a significantly higher TF family diversity (1.9 ± 0.5) than tissue\hyp{}specific CRMs (1.8 ± 0.6;~\textit{P} \textless{} 0.05).
...
%Dunn's posthocs with Bonferroni correction revealed that tissue\hyp{}specific CRMs (1.4 ± 0.8) had a significantly lower TF family diversity than control CRMs (1.8 ± 0.6;~\textit{P} \textless{} 0.01).
...
%However, Dunn's posthocs with Bonferroni correction revealed no significant difference between groups (\textit{P} \textgreater{} 0.05).
...
%Dunn's posthocs with Bonferroni correction revealed that non\hyp{}specific CRMs (2.1 ± 1.2) had a significantly lower TF diversity than control CRMs (2.3 ± 1.0;~\textit{P} \textless{} 0.05).
...
Dunn's posthocs with Bonferroni correction revealed that non\hyp{}specific CRMs (1.3 ± 0.8) had a significantly lower TF diversity than control CRMs (1.5 ± 0.7;~\textit{P} \textless{} 0.05) and tissue\hyp{}specific CRMs (1.5 ± 0.7;~\textit{P} \textless{} 0.05).
...
Dunn's posthocs with Bonferroni correction revealed that the mean Tau tissue\hyp{}specificity was significantly higher for TFs binding non\hyp{}specific CRMs (0.70 ± 0.16) than TFs binding tissue\hyp{}specific CRMs (0.66 ± 0.16;~\textit{P} \textless{} 0.01; \autoref{fig:TFBS-TF-class-400bpprom-openchrom}).
%add figure%
\begin{figure}[hbt!]
	\begin{center}
		\capstart
...
%170 TFs in each category chosen - as only 571 TFs present in all genes set and needs to be divisible by 10 for the control set. Not many of the TFs predicted to bind promoters in the whole geneset (18 cv, 23 tau with top 150 TFs in each category). Control set still need standardising between the two sets. Leave this analysis out of chapter as samples sizes too small!
