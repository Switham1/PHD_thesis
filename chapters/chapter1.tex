...
Dunn's posthocs revealed that mean percentage GC content was significantly higher in constitutive CRMs (\SI{32.8}\percent{} ± 4.3) than variable CRMs  (\SI{31.7}\percent{} ± 3.6; ) (\autoref{fig:gc-content-wholeprom}A).
...
In the same 400 bp CRM region there was a significant difference between non\hyp{}specific, tissue\hyp{}specific and control CRMs (Kruskal\hyp{}Wallis~\textit{H} = 22.8,~\textit{P} \textless{} 0.0001). Dunn's posthocs revealed that non\hyp{}specific (\SI{33.6}{\percent} ± 5.6; ~\textit{P} \textless{} 0.001) and control CRMs (\SI{33.8}{\percent} ± 4.2; ~\textit{P} \textless{} 0.0001) had a significantly higher GC content  than tissue\hyp{}specific CRMs (\SI{31.2}{\percent} ± 3.9). 
