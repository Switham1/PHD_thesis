...
The TF Tau tissue\hyp{}specificity of TFs predicted to bind CRMs in open chroamtin  also did not differ significantly between tissue\hyp{}specific, non\hyp{}specific and control CRMs (\textit{N} = 37; Kruskal\hyp{}Wallis~\textit{H} = 3.3, ~\textit{P} \textless{} 0.05).
...
However, Dunn's posthocs did not reveal an significant difference between categories ( ~\textit{P} \textgreater{} 0.05).
