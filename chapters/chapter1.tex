...
When analyses were repeated using the top 300 CRMs in each category, all GC content findings supported those when using the top 100 CRMs.
...
There was no significant difference in TF (Kruskal\hyp{}Wallis~\textit{H} = 0.9,~\textit{P} \textgreater{} 0.05) or TF family Shannon diversity (Kruskal\hyp{}Wallis~\textit{H} = 0.5,~\textit{P} \textgreater{} 0.05) between constitutive, variable or control types \autoref{fig:tf-diversity-wholeprom}).
 ...
 \begin{figure}[hbt!]
	\begin{center}
		...
		\caption{
			...
			D: Median Shannon diversity of TF families in 100 bp windows.
...
The findings supported the results found with the top 100 CRMs in each category.
