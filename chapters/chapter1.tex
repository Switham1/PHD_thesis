...
Dunn's post\hyp{}hoc tests with Bonferroni adjustment revealed that constitutive promoters had a significantly higher GC content (33.2 ± \SI{4.5}{\percent}) than variable promoters (31.8 ± \SI{3.6}{\percent}; \ref{fig:gc-content-wholeprom}).

\begin{figure}[!h]
	\begin{center}
		\capstart
		\includegraphics[width=0.50\columnwidth]{genetype_GC_content/wholeprom/Czechowski_GC_content_box}
		\caption{
...
A sliding window analysis of GC content was 


\begin{figure}[!h]
	\begin{center}
		\capstart
		\includegraphics[width=0.50\columnwidth]{genetype_bp_covered/wholeprom/Czechowski_TFBS_coverage_box}
		\caption{
