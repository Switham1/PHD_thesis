...
\subsection{Variable and tissue-specific genes}
...
\textcite{czechowskiGenomeWideIdentificationTesting2005} ranked the stability of genes based on their coefficient of variation. Only genes present in \SI{80}{\percent} or more of developmental stages and tissues were included in the analysis. This means that the variably expressed genes excluded tissue-specific genes and were classed based on how variable their expression was across the different tissues and developmental stages. This was by design to try to select stably expressed housekeeping genes for use as reference genes. It would be useful to calculate the coefficient of variation without excluding tissue-specific genes.

Therefore, genes from the same microarray experiment were also ranked using Tau tissue-specificity to compare differences between them. It is reasonable to expect that tissue-specific genes will have different promoter architectures to constitutive and the variably expressed non-tissue-specific genes.
