...
\begin{figure}[hbt!]
	\begin{center}
		...
		\caption{
			\textbf{Sliding window analysis of GC content in different Arabidopsis \textit{cis}\hyp{}regulatory module (CRM) categories.}
			...
			The windows were overlapping with a 50 bp offset.
			The median value for each bin is displayed here at the central bp of the bin.
			Shading represents 95 confidence intervals estimated using 10000 bootstraps. \textit{N}=100.	
			A: constitutive and variable GC content sliding windows.
...
\begin{figure}[hbt!]
	\begin{center}
		...
		\caption{
			\textbf{Percentage GC content of different Arabidopsis \textit{cis}\hyp{}regulatory module (CRM) categories in a 400 bp region upstream of the ATG start codon.}
...
\begin{figure}[hbt!]
	\begin{center}
		...
		\caption{
			\textbf{Percentage TFBS coverage of different Arabidopsis \textit{cis}\hyp{}regulatory module (CRM) expression categories.}
			Promoters were extracted 1000 bp upstream of the annotated Araport 11 \autocite{chengAraport11CompleteReannotation2017} TSS or until the nearest gene.
			5UTRs were extended downstream of the TSS to the closest coding region.  Box plots have box boundaries that represent 25th, 50th (median) and 75th percentiles; whiskers are drawn up to the largest or smallest observed point that falls within 1.5 times the interquartile range.
			Control genes are identical in plots A and B.
...
\begin{figure}[hbt!]
	\begin{center}
		...
		\caption{
			\textbf{Percentage coverage of TFBS falling within open chromatin across different Arabidopsis \textit{cis}\hyp{}regulatory module (CRM) expression categories.}
			Promoters were extracted 1000 bp upstream of the annotated Araport 11 \autocite{chengAraport11CompleteReannotation2017} TSS or until the nearest gene.
			5UTRs were extended downstream of the TSS to the closest coding region.  Box plots have box boundaries that represent 25th, 50th (median) and 75th percentiles; whiskers are drawn up to the largest or smallest observed point that falls within 1.5 times the interquartile range.
			Open chromatin peaks derived from the intersect of root and shoot peaks derived from negative control (treated with NaOH) ATAC\hyp{}seq data by \textcite{potterCytokininModulatesContextdependent2018}.
			Control genes are identical in plots A and B.
