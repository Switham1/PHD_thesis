...
A sliding window analysis revealed that the biggest differences in GC content with small confidence intervals between constitutive and variable promoters was \textasciitilde{}400 bp upstream of the ATG start codon (\autoref{fig:all-combined-sliding-window}).
...
To confirm whether this was a genuine difference or due to different 5'UTR lengths between constutitive and variable genes, the percentage of root\hyp{}shoot intersect open chromatin of windows was plotted centred around the Araport11 TSS (\autoref{fig:gc-content-sliding-window-araporttss}).
