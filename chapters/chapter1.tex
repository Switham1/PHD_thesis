...
\begin{figure}[hbt!]
	\begin{center}
		...
		\caption{
			\textbf{Percentage open chromatin coverage of 100 constitutive (blue), 100 variable (orange), 100 non\hyp{}specific (light green), 100 tissue\hyp{}specific (grey) and 100 control (green/brown) Arabidopsis \textit{cis}\hyp{}regulatory modules (CRMs).}		
...
\begin{figure}[!hbt]
	\begin{center}
		...
		\caption{
			\textbf{Sliding window analysis of 100 constitutive (blue) and 100 variable (orange) (A) and 100 non\hyp{}specific and 100 tissue\hyp{}specific (B) Arabidopsis \textit{cis}\hyp{}regulatory modules (CRMs) upstream of the start codon.}
			Promoters were extracted 1000 bp upstream of the annotated Araport 11 \autocite{chengAraport11CompleteReannotation2017} TSS or until the nearest gene.
...
\begin{figure}[!hbt]
	\begin{center}
		...
		\caption{
			\textbf{Sliding window analysis of 100 constitutive (blue) and 100 variable (orange) (A) and 100 non\hyp{}specific and 100 tissue\hyp{}specific (B) Arabidopsis \textit{cis}\hyp{}regulatory modules (CRMs) centred around the transcription start site (TSS).}
			Promoters were extracted 1000 bp upstream of the annotated Araport 11 \autocite{chengAraport11CompleteReannotation2017} TSS or until the nearest gene.
			5UTRs were extended downstream of the TSS to the closest coding region.
...
\begin{figure}[hbt!]
	\begin{center}
		...
		\caption{
			\textbf{Percentage GC content of 100 constitutive (blue), 100 variable (orange), 100 non\hyp{}specific (light green), 100 tissue\hyp{}specific (grey) and 100 control (green/brown) Arabidopsis \textit{cis}\hyp{}regulatory modules (CRMs).}
			Promoters were extracted 1000 bp upstream of the annotated Araport 11 \autocite{chengAraport11CompleteReannotation2017} TSS or until the nearest gene.
			...
			A: Percentage GC content in 100 constitutive, variable and control genes. *, \textit{P} \textless{} 0.05. ns, not significant.
			B: Percentage GC content in 100 non\hyp{}specific, tissue\hyp{}specific and control genes. There was no significant difference in GC content between categories.
...
\begin{figure}[hbt!]
	\begin{center}
		...
		\caption{
			\textbf{Sliding window analysis of GC content in 100 constitutive (blue) and 100 variable (orange) (A) and 100 non\hyp{}specific (light green) and 100 tissue\hyp{}specific (grey) (B) Arabidopsis \textit{cis}\hyp{}regulatory modules (CRMs).}
...
\begin{figure}[hbt!]
	\begin{center}
		...
		\caption{
			\textbf{Percentage GC content of 100 constitutive (blue), 100 variable (orange), 100 non\hyp{}specific (light green), 100 tissue\hyp{}specific (grey) and 100 control (green/brown) Arabidopsis \textit{cis}\hyp{}regulatory modules (CRMs) in a 400 bp region upstream of the ATG start codon.}
			...
			Control genes are identical in plots A and B.
			Significance was calculated using Kruskal\hyp{}Wallis and Dunn's posthocs with Bonferroni correction.
			A: Percentage GC content in 100 constitutive, variable and control CRMs.
			B: Percentage GC content in 100 non\hyp{}specific, tissue\hyp{}specific and control genes.
...
TFBS coverage was not significantly different between CRM types. (Kruskal\hyp{}Wallis~\textit{H} = 5.1,~\textit{P} \textgreater{} 0.05; \autoref{fig:tfbs-coverage-wholeprom}).
The hypothesis that non\hyp{}specific genes have a higher TFBS coverage than tissue\hyp{}specific genes was also  tested. TFBS coverage did not differ significantly between non\hyp{}specific, tissue\hyp{}specific or control CRM types at the whole promoter level.
...
\begin{figure}[hbt!]
	\begin{center}
		...
		\caption{
			\textbf{Percentage TFBS coverage of 100 constitutive (blue), 100 variable (orange), 100 non\hyp{}specific (light green), 100 tissue\hyp{}specific (grey) and 100 control (green/brown) Arabidopsis \textit{cis}\hyp{}regulatory modules (CRMs).}
			Promoters were extracted 1000 bp upstream of the annotated Araport 11 \autocite{chengAraport11CompleteReannotation2017} TSS or until the nearest gene.
			5UTRs were extended downstream of the TSS to the closest coding region.  Box plots have box boundaries that represent 25th, 50th (median) and 75th percentiles; whiskers are drawn up to the largest or smallest observed point that falls within 1.5 times the interquartile range.
			Control genes are identical in plots A and B.
			Significance was calculated using Kruskal\hyp{}Wallis.
			A: There was no significant difference in TFBS coverage between constitutive, variable or control CRMs.
			B: There was no significant difference in TFBS coverage between non\hyp{}specific, tissue\hyp{}specific or control CRMs.
...
A sliding window analysis revealed that TFBS coverage was higher in variable CRMs than constitutive CRMs (\autoref{fig:tfbs-coverage-sliding-window}A) and higher in tissue\hyp{}specific CRMs than in non\hyp{}specific CRMs (\autoref{fig:tfbs-coverage-sliding-window}B) in the first 400 bp region upstream of the ATG.
 ...
 \begin{figure}[hbt!]
	\begin{center}
		...
		\caption{
			\textbf{Sliding window analysis of TFBS coverage in 100 constitutive (blue) and 100 variable (orange) (A) and 100 non\hyp{}specific (light green) and 100 tissue\hyp{}specific (grey) (B) Arabidopsis \textit{cis}\hyp{}regulatory modules (CRMs).}
			Promoters were extracted 1000 base pairs (bp) upstream of the annotated Araport 11 \autocite{chengAraport11CompleteReannotation2017} TSS or until the nearest gene.
			5'UTRs were extended downstream of the TSS to the closest coding region.
