...
When analyses were repeated using the top 300 CRMs in each category, all TFBS coverage findings supported those when using the top 100 CRMs except for the following findings.
...
Dunn's posthocs with Bonferroni correction revealed that
