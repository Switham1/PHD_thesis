...
\begin{figure}[!h]
	\begin{center}
		\capstart
		\includegraphics[width=1\columnwidth]{openchromatin/Czechowski_genetypenocontrol_percentage_bases_covered_rootshootintersect_chrom_median_sliding_window}
		\caption{
...
\begin{figure}[!h]
	\begin{center}
		\capstart
		\includegraphics[width=1\columnwidth]{openchromatin/Araport11_Czechowski_genetypenocontrol_median_openchromatin_sliding_window}
		\caption{
