...
A sliding window analysis revealed that TFBS coverage was higher in variable CRMs than constitutive CRMs and higher in tissue\hyp{}specific CRMs than in non\hyp{}specific CRMs in the first 400 bp region upstream of the ATG (\autoref{fig:tfbs-coverage-sliding-window}A\&B).
