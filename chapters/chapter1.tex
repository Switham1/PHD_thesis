...
Percentage coverage of TFBSs falling within open chromatin in the 400 bp region was significantly different between constitutive, variable and control CRMs (Kruskal\hyp{}Wallis~\textit{H} = 13.2,~\textit{P} \textless{} 0.1; \autoref{fig:tfbs-coverage-400bpprom-openchrom}).
