...
Further analysis in the first 400 bp upstream of the ATG start codon showed that there was a significant difference between constitutive, variable and control promoter types (Kruskal\hyp{}Wallis~\textit{H} = 14.8,~\textit{P} \textless{} 0.001).
Dunn's posthoc tests with Bonferroni correction revealed that within the 400 bp region constitutive promoters had a significantly higher GC content (\SI{35.0}{\percent} ± 5.0) than variable promoters (\SI{33.1}{\percent} ± 4.7; ~\textit{P} \textless{} 0.001) and control promoters (\SI{33.8}{\percent} ± 4.2; ~\textit{P} \textless{} 0.05) (\autoref{fig:gc-content-400bpprom}).
