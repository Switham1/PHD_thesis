...
\begin{figure}[hbt!]
	\begin{center}
		\capstart
		\includegraphics[width=0.70\columnwidth]{genes/constitutive_300genes}
		\caption{
			\textbf{Gene ontology lineage plot for the top 300 constitutive \textit{Arabidopsis thaliana} genes.}
			Top 300 constitutive genes were chosen based on coefficient of variation (CV) values as in \textcite{czechowskiGenomeWideIdentificationTesting2005} after filtering overlapping genes and genes with no TFBSs in their promoters.
...
\begin{figure}[hbt!]
	\begin{center}
		\capstart
		\includegraphics[width=0.70\columnwidth]{genes/variable_300genes}
		\caption{
			\textbf{Gene ontology lineage plot for the top 300 constitutive \textit{Arabidopsis thaliana} genes.}
			Top 300 variable genes were chosen based on coefficient of variation (CV) values as in \textcite{czechowskiGenomeWideIdentificationTesting2005} after filtering overlapping genes and genes with no TFBSs in their promoters.
