...
Dunn's posthocs showed that tissue\hyp{}specific CRMs had significantly higher TFBS percentage coverage (\SI{25.1}{\percent} ± 14.6) than non\hyp{}specific CRMs (\SI{19.4}{\percent} ± 13.3; \textit{P} \textless 0.05; \autoref{fig:tfbs-coverage-400bpprom}B).
...
Percentage coverage of TFBS falling within open chromatin in the 400 bp region was significantly different between 
