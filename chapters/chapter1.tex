...
The TF expression CV of TFs binding CRMs did not differ significantly between constitutive, variable and control CRMs (\textit{N} = 100; Kruskal\hyp{}Wallis~\textit{H} = 1.9, ~\textit{P} \textgreater{} 0.05).
The TF Tau tissue\hyp{}specificity of TFs binding CRMs did not differ significantly between tissue\hyp{}specific, non\hyp{}specific and control CRMs (\textit{N} = 300; Kruskal\hyp{}Wallis~\textit{H} = 3.8, ~\textit{P} \textless{} 0.05)
