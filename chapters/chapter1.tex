...
\begin{figure}[hbt!]
	\begin{center}
		...
		\caption{
			...
			A: Percentage base pairs (bp) covered by open chromatin in 100 constitutive, variable and control genes. *, \textit{P} \textless{} 0.05. ns, not significant.
			B: Percentage base pairs (bp) covered by open chromatin in 100 non\hyp{}specific, tissue\hyp{}specific and control genes. There was no significant difference in GC content between categories.
