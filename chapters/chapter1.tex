...
There was also no significant difference in TF (\textit{N} = 300; Kruskal\hyp{}Wallis~\textit{H} = 0.8, ~\textit{P} \textgreater{} 0.05) or TF family diversity (\textit{N} = 300; Kruskal\hyp{}Wallis~\textit{H} = 1.0, ~\textit{P} \textgreater{} 0.05) when only using TFBSs falling within open chromatin.
...
There was a significant difference TF family diversity non\hyp{}specific, tissue\hyp{}specific or control CRMs (\textit{N} = 300, Kruskal\hyp{}Wallis~\textit{H} = 8.0, ~\textit{P} \textless{} 0.05).
...
Using only TFBSs falling within open chromatin
