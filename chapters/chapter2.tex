...
\chapter{Architectural differences in \textit{Cis}\hyp{}regulatory modules between constitutive, variable, non\hyp{}specific and tissue\hyp{}specific genes}\label{chapter2}
...
\section{Introduction}\label{chapter2:introduction}
...
\subsection{Variably expressed and tissue-specific genes}\label{chapter2:introduction:variable-tissue-specific-genes}
...
\subsection{GC content}\label{chapter2:introduction:gc-content}
...
\subsection{TFBS coverage}\label{chapter2:introduction:tfbs-coverage}
...
The first 500 bp upstream of the TSS were found to contain a stronger correlation between breadth of stimuli response and motif density than 500\textendash1000 bp upstream and 1000\textendash3000 bp upstream of the TSS~\autocite{waltherRegulatoryCodeTranscriptional2007}.
...
\subsection{TF diversity}\label{chapter2:introduction:tf-diversity}
...
\section{Methods}\label{chapter2:methods}
...
\label{chapter2:methods:sliding-window-creation}
...
\label{chapter2:methods:tfs-binding-crms}
...
\section{Results}\label{chapter2:results}
...
CRMs from the four gene sets were overlapped with ATAC-seq data \autocite{potterCytokininModulatesContextdependent2018}.
