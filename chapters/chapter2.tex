...
\chapter{Architectural differences in \textit{Cis}\hyp{}regulatory modules between constitutive, variable, non\hyp{}specific and tissue\hyp{}specific genes}
\label{chapter2}
...
\label{chapter2:introduction:variable-tissue-specific-genes}
...
\label{chapter2:introduction:gc-content}
...
\label{chapter2:introduction:tfbs-coverage}
...
The first 500 bp upstream of the TSS were found to contain a stronger correlation between breadth of stimuli response and motif density than 500-1000 bp upstream and 1000-3000 bp upstream of the TSS \autocite{waltherRegulatoryCodeTranscriptional2007}.
...
\label{chapter2:introduction:tf-diversity}
...
\label{chapter2:methods:transcription-factor-binding-site-identification}
...
\subsection{GC content}
{\label{chapter2:methods:gc-content}}
...
{\label{chapter2:methods:transcription-factor-binding-site-coverage}}
...
{\label{chapter2:methods:open-chromatin-coverage}}
...
\subsection{TF diversity}
{\label{chapter2:methods:tf-diversity}}
...
\label{chapter2:methods:tata-box-enrichment}
...
\label{chapter2:methods:functional-analysis}
